...
const makePlan=()=>prepareReviewPlan({repoDir:repo,subject:'smoke/sum#1',baseBranch:'staging',instructions:'Review the sum function. It must return 0 for an empty array. Inspect source; do not modify files.',policy:'smoke-v1',root:join(root,'memory')});
...
await savePublishedReview(first.p,first.f.snapshot);
